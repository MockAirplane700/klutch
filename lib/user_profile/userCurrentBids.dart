...
class UserCurrentBids extends StatefulWidget {
  @override
  _UserCurrentBidsState createState() => _UserCurrentBidsState();
}

class _UserCurrentBidsState extends State<UserCurrentBids> {
  String clothesId , amount, name, logo, currBid, prevBid,price;
  String uid = "nu8A8DDY8dVFsWVmhdsBkKmunSf1";
  List clothesList = List();
  ...
  initilizeFirebase() async {
    ...
    return await FirebaseFirestore.instance.collection('Users').doc(uid).collection('currentBids').get();
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: screenHeight / 90,),
              Text('Previous Bid' , style: GoogleFonts.roboto(
                color: Colors.black
              ),),
              SizedBox(height: screenHeight / 90,),
              Text(prevBid , style: GoogleFonts.roboto(
                  color: Colors.black
              ),),
              SizedBox(height: screenHeight / 90,),
              Text('Current bid' , style: GoogleFonts.roboto(
                  color: Colors.black
              ),),
              SizedBox(height: screenHeight / 90,),
              Text(currBid , style: GoogleFonts.roboto(
                  color: Colors.black
              ),),
                      ...
                      children: <Widget>[
                        FlatButton(
                          onPressed: () {
                            ...
                            _showMyDialogue("Update your bid", "Bid");
                          },
                          child:Text("Update Bid", style: TextStyle(
                              color: Colors.white
                          ),),
                          color: Colors.pink,
                        )
