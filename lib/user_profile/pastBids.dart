...
class UserPastBids extends StatefulWidget {
  @override
  _UserPastBidsState createState() => _UserPastBidsState();
}

class _UserPastBidsState extends State<UserPastBids> {
  ...
  Widget build(BuildContext context) {
    int size = 0;
    String name, logo , price, currBid;
    return Scaffold(
      appBar:AppBar(
        title: Center(
  ...
  initilizeFirebase() async {
    ...
    return await FirebaseFirestore.instance.collection('Users').doc(uid).collection('pastBids').get();
  }
              ...
              Row(
                children: <Widget>[
                  Expanded(
                    child: Column(
                      children: <Widget>[
                       Text("Winning Bid" , style: GoogleFonts.roboto(
                         color: Colors.black,
                       ),),
                        Text("\$ 90.00" , style: GoogleFonts.roboto(
                          color: Colors.black
                        ),)
...
//                        ),)
              ...
              FlatButton(
                onPressed: () {
                  //open dialog box to place new bid
                  _showMyDialogue("Place bid", "Bid");
                },
                child: Text("Place bid" ,style: GoogleFonts.roboto(
                  color: Colors.white
                ),),
